...
>
> **Important:** Use the **same** value for ``<your-api-name>`` everywhere it appears in this lab (including all subsequent SQL snippets that reference the credential URL). The credential lookup is by exact URL match.
...
> **Note:** Replace ``<your-api-name>`` with the name of your **Azure OpenAI** service.

```SQL

    declare @url nvarchar(4000) = N'https://<your-api-name>.openai.azure.com/openai/deployments/text-embedding-ada-002/embeddings?api-version=2024-06-01';
...
1. Again, click the run button on the query sheet. The result will be a JSON vector array.
    ...
    ![A picture of the JSON vector array as a result of the query](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-10_11.25.57_AM.png)
...
1. Then click the run button on the query sheet
    ...
    ![A picture of clicking the run button on the query sheet for adding 2 columns to the product table](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-10_1.30.19_PM.png)
...
> **Note:** Replace ``<your-api-name>`` with the name of your **Azure OpenAI** service.
 ...
 ```SQL
    ...
    AS
    BEGIN
    declare @url varchar(max) = 'https://<your-api-name>.openai.azure.com/openai/deployments/text-embedding-ada-002/embeddings?api-version=2024-06-01';
...
1. Run the next query in a blank query editor in Microsoft Fabric to see the results of the above update to the Products table:
    ...
    ![A picture of the query result showing the chunk and embeddings columns and their data.](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_6.34.32_AM.png)
...
1. The first query will pose the question "I am looking for a red bike and I dont want to spend a lot". The key words that should help with our similarity search are red, bike, and dont want to spend a lot. Run the following SQL in a blank query editor in Microsoft Fabric:
    ...
    ![A picture of running Query 1 and getting results outlined in the Query 1 results table.](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_6.36.01_AM.png)
...
1. The next search will be looking for a safe lightweight helmet. Run the following SQL in a blank query editor in Microsoft Fabric:
    ...
    ![A picture of running Query 2 and getting results outlined in the Query 2 results table](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-14_6.00.32_AM.png)
...
1. You can test this newly created procedure to see how it will interact with the GraphQL API by running the following SQL in a blank query editor in Microsoft Fabric:
    ...
    ![A picture of running the find_products_api stored procedure](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-14_6.57.09_AM.png)

1. To create the GraphQL API, click on the **New API for GraphQL** button on the toolbar.

    ![A picture of clicking on the New API for GraphQL button on the toolbar](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_6.52.37_AM.png)

1. In the **New API for GraphQL** dialog box, use the **Name Field** and name the API **find_products_api**.

    ![A picture of using the Name Field and naming the API find_products_api in the New API for GraphQL dialog box](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_7.35.03_AM.png)

1. After naming the API, click the **green Create button**.

    ![A picture of clicking the green Create button in the New API for GraphQL dialog box](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_7.35.09_AM.png)
...
1.  The next dialog box presented is the **Choose data** dialog box where you will pick a table or stored procedure for the GraphQL API, 
    ...
    ![A picture of the next dialog box being presented, the Choose data dialog box](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_7.00.42_AM.png)

    use the **Search box** in the **Explorer section** on the left 
    
    ![A picture of using the Search box in the Explorer section on the left of the Choose data dialog box](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_7.01.39_AM.png)

    and **enter in find_products_api**.

    ![A picture of enter in find_products_api in the search box](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_6.26.15_AM.png)
...
1. Choose the **find_products_api stored procedure in the results**. You can ensure it is the find_products_api stored procedure by hovering over it with your mouse/pointer. It will also indicate the selected database item in the preview section. It should state **"Preview data: dbo.find_products_api"**.
    ...
    ![A picture of choosing the find_products_api stored procedure in the results](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_6.28.44_AM_copy.png)
...
1. Once you have selected the **find_products_api stored procedure**, click the **green Load button** on the bottom right of the modal dialog box.
    ...
    ![A picture of clicking the green Load button on the bottom right of the modal dialog box](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_6.30.18_AM.png)
...
1. You will now be on the **GraphQL Query editor page**. Here, we can run GraphQL queries similar to how we can run T-SQL queries on the query editor.
    ...
    ![A picture of the GraphQL Query editor page](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_7.11.21_AM.png)
...
1. Replace the sample code on the left side of the GraphQL query editor with the following query:
    ...
    ![A picture of replacing the example code with the query code provided](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_7.16.57_AM.png)

1. Now, click the **Run button** in the upper left of the GraphQL query editor. 

    ![A picture of clicking the Run button in the upper left of the GraphQL query editor](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_7.19.13_AM.png)

    and you can scroll through the results from the GraphQL query in the lower section of the editor.

    ![A picture of scrolling through the results from the GraphQL query in the lower section of the editor](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_7.21.01_AM.png)

1. Back on the toolbar, find and click the **Generate code button**.

    ![A picture of clicking the Generate code button](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_8.38.00_AM.png)
...
1. This feature will generate the code for calling this API via python or node.js to help give you a jumpstart in the application creation process.
    ...
    ![A picture of the generated code the editor provides](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_8.40.12_AM.png)
...
1. When done looking at the python and node.js code, click the **X** in the upper right corner to close the Generate code dialog box.
    ...
    ![A picture of clicking the X in the upper right corner to close the Generate code dialog box](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-15_8.40.12_AM2.png)
...
```SQL
    ...
    declare @url nvarchar(4000) = N'https://<your-api-name>.openai.azure.com/openai/deployments/gpt-4.1/chat/completions?api-version=2024-06-01';
...
1. Copy and run the following SQL in a blank query editor in Microsoft Fabric:
    ...
    and p.ProductID = d.ProductID
    and d.Culture = 'en')
    select @products_json = STRING_AGG(CONVERT(NVARCHAR(max),CONCAT( 
                                    product_name, ' ' ,
                                    product_color, ' ',
                                    category_name, ' ', 
                                    model_name, ' ', 
...
1. You can test this new  procedure to see how Azure OpenAI will answer a question with product data by running the following SQL in a blank query editor in Microsoft Fabric:
    ...
    ![A picture of running the find_products_chat_api stored procedure](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_6.15.05_AM.png)
...
1. In the **New API for GraphQL** dialog box, use the **Name Field** and name the API **find_products_chat_api**.
    ...
    ![A picture of using the Name Field and naming the API find_products_chat_api in the New API for GraphQL dialog box](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_7.34.39_AM.png)

1. After naming the API, click the **green Create button**.

    ![A picture of clicking the green Create button in the New API for GraphQL dialog box](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_7.34.47_AM.png)
...
1.  The next dialog box presented is again the **Choose data** dialog box where you will pick a table or stored procedure for the GraphQL API, 
    ...
    ![A picture of enter in find_products_chat_api in the search box](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_6.24.33_AM.png)
...
1. Choose the stored procedure in the results. You can ensure it is the **find_products_chat_api stored procedure** by hovering over it with your mouse/pointer. It will also indicate the selected database item in the preview section. It should state **"Preview data: dbo.find_products_chat_api"**.
    ...
    ![A picture of choosing the find_products_chat_api stored procedure in the results](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_6.34.33_AM.png)
...
1. Once you have selected the **find_products_chat_api stored procedure**, click the **green Load button** on the bottom right of the modal dialog box.
    ...
    ![A picture of clicking the green Load button on the bottom right of the modal dialog box](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_6.32.43_AM.png)
...
1. Replace the sample code on the left side of the GraphQL query editor with the following query:
    ...
    ![A picture of replacing the sample code on the left side of the GraphQL query editor with the supplied code](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_6.40.03_AM.png)

1. Now, **click the Run button** in the upper left of the GraphQL query editor.

    ![A picture of clicking the Run button in the upper left of the GraphQL query editor](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_6.37.51_AM.png)    

1. And you can review the response in the **Results** section of the editor

    ![A picture of reviewing the response in the Results section of the editor](https://raw.githubusercontent.com/microsoft/Azure-Analytics-and-AI-Engagement/FabCon-Vienna-SQL-database-in-Fabric-Workshop/media/2025-01-17_6.41.24_AM.png)
